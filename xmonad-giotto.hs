...
--
myTerminalSmall      = "rxvt-unicode -tn xterm -uc -bc -st -sr -si -sk -T null -title null -bg \\#`/home/anze/local/bin/randcolor.py` -fg \\#EEEEEE -fn xft:Mono:pixelsize=18"
myTerminalLarge      = "rxvt-unicode -tn xterm -uc -bc -st -sr -si -sk -T null -title null -bg \\#`/home/anze/local/bin/randcolor.py` -fg \\#EEEEEE -fn xft:Mono:pixelsize=32"
...
myTerminalKosovel      = "rxvt-unicode -tn xterm -uc -bc -st -sr -si -sk -T null -title kos -bg \\#`/home/anze/local/bin/randcolor.py` -fg \\#DDDDDD -fn xft:Mono:pixelsize=14 -e ssh kosr"
